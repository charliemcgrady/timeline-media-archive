...
# -------------------------------------------------------------
# This file releases a new version of the server.
# -------------------------------------------------------------
...
docker build -t node-server ./app --build-arg NODE_ENV=production --no-cache --file app/Dockerfile-node-server
...
export TF_VAR_node_server_image_version=${RELEASE_UUID}
